      ...
      <aside className={`dash-sidebar ${mobileOpen ? 'open' : ''}`}>
        ...
        <div className="dash-sidebar-user">
          ...
          <div className="dash-user-info">
            <span className="dash-user-name">أحمد محمد</span>
            <span className="dash-user-grade">
              {selectedGrade === 'grade-1' ? 'الصف الأول الثانوي' : 'الصف الثاني الثانوي'}
            </span>
          </div>
        </div>
        ...
        <header className="dash-header">
          ...
          <div className="dash-header-right">
            ...
            <div className="dash-profile-chip">
              <div className="dash-chip-avatar">أح</div>
              <div className="dash-chip-details">
                <span className="dash-chip-name">أحمد محمد</span>
                <span className="dash-chip-role">طالب</span>
              </div>
